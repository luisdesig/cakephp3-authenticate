...
INSERT INTO  personas  ( nombres ,  apepaterno ,  apematerno, nombrecompleto,  fechanacimiento ,  prmtipodocumento ,  numerodocumento ,  prmgenero ,  created ,  modified ) VALUES
('administrador', 'del', 'sistema', 'administrador del sistema', '2016-12-15', 1, '23456723', 1, '2016-12-15', NULL);

INSERT INTO  users  (  persona_id, nombrecompleto,  email ,  username ,  password ,  passtoken ,  passtokenfecha ,  fotodir ,  foto ,  activo ,  eliminado ,  status ,  created ,  modified ) VALUES
( 1, 'administrador del sistema', 'admin@admin.com', 'admin', '$2y$10$.5BwWje6vLYfjsrELeNPzO2IGOXY.gFVEYax8n038kAhBhC0tGoYi', NULL, NULL, 'b8d7708b-22dd-482a-8694-0481545c57b3', '20151129_154444.jpg', 'S', 'N', 1, '05-12-2016', '05-12-2016');

INSERT INTO  parametros  (parent_id ,  tipo ,  valor ,  codigo ,  fecha ,  nombre ,  descripcion ,  lft ,  rght ,  created ,  modified ) VALUES
