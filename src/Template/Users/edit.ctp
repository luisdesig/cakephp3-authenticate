            ...
            <div class="box-body">
                ...
                <div class="col-md-8">
                    <div class="row">
                     ...
                     ?>
                    <div class="col-md-4"><?=$this->Form->input('persona.nombres', ['label'=>'Nombres']);?></div>
                    <div class="col-md-4"><?=$this->Form->input('persona.apepaterno', ['label'=>'Apellido Paterno']);?></div>
                    <div class="col-md-4"><?=$this->Form->input('persona.apematerno', ['label'=>'Apellido Materno']);?></div>
                    </div>
